...
The main goal here is to create a Home and Away table separately. Once that's done, I'll be able to do more
manipulation and create better visualization.
...
![plot of chunk bplcomparison](figure/bplcomparison-1.png)
